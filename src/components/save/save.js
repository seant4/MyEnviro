...
import solarpan from './assets/solar.png';
    ...
    return(
        <div className="Container">
            ...
            <CardColumns className="CardColumnsStyle">
                <SaveInfoBox image={bicycle} title={["I carpooled today", "I walked today", "I invested in an electric car"]} name="Movement" onClick={[function(){handleShow(5)}, function(){dispatch(carpool())}, function(){dispatch(carpooln())}, function(){handleShow(10)}, function(){dispatch(walk())}, function(){dispatch(walkn())}, function(){handleShow(25)}, function(){dispatch(electriccar())}, function(){dispatch(carn())}]} description="Carpooling, walking, biking, or driving a fuel efficient car are all examples of eco-friendly transportation, and help reduce Carbon emissions." />
                <SaveInfoBox image={recycle} title={["I picked up trash today", "I used a metal straw today", "I invested in an compost bin"]}name="Waste" onClick={[function(){handleShow(5)}, function(){dispatch(trash())}, function(){dispatch(trashn())}, function(){handleShow(5)}, function(){dispatch(strawn())}, function(){dispatch(straw())}, function(){handleShow(25)}, function(){dispatch(compostn())}, function(){dispatch(compost())}]} description="Recycling, not using plastic straws, and using a compost bin are all eco-friendly ways of disposing of trash that help clean the earth." />
                <SaveInfoBox image={solarpan} title={["I turned off the lights today", "I turned off the AC or heating today ", "I invested in solar energy!"]}name="Power" onClick={[function(){handleShow(2)}, function(){dispatch(lights())}, function(){dispatch(lightsn())}, function(){handleShow(3)}, function(){dispatch(ac())}, function(){dispatch(acn())}, function(){handleShow(25)}, function(){dispatch(solar())}, function(){dispatch(solarn())}]} description="Turning off the lights, using less wall power, or even using a solar panel are all eco-friendly ways to reduce your power consumption."/>
                <SaveInfoBox image={pines} title={["I planted a tree", "I planted a garden", "I invested in an electric car"]}name="Nature" onClick={[function(){handleShow(25)}, function(){dispatch(tree())}, function(){dispatch(treen())}, function(){handleShow(25)}, function(){dispatch(garden())}, function(){dispatch(gardenn())}]} description="Plant a tree, start a garden, or pick up trash in your area, do whatever you can to help bring back the environment on earth                                                                                                            " />
            </CardColumns>
